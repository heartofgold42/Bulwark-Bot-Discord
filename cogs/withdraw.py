...
class Withdraw:
    ...
    async def withdraw(self, ctx, address:str, amount:float):
        """Withdraw coins from your account to any Bulwark address"""
        ...
        await self.bot.say("{} **Withdrew {} BWK! :money_with_wings:**\nView the transaction here: https://chainz.cryptoid.info/bwk/tx.dws?{}.htm".format(ctx.message.author.mention, str(amount), txid))
